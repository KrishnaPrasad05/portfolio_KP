...
export const HERO_CONTENT = `I am a passionate application developer with a strong foundation in React, Angular, Node.js, Express.js, MongoDB, Mongoose, and Redux. I have a keen eye for UI/UX design, leveraging Figma to create intuitive and user-friendly interfaces. My programming knowledge extends to Java, and I am proficient in working with both MySQL and MongoDb. I thrive on building efficient, scalable web applications and am always eager to learn and apply new technologies to solve complex problems.`;

export const ABOUT_TEXT = `I am a dedicated and enthusiastic application developer with a comprehensive skill set in modern web development technologies. My expertise lies in building dynamic and responsive web applications using React, Angular, Node.js, Express.js, MongoDB, Mongoose, and Redux. I have a strong understanding of both frontend and backend development, allowing me to create seamless and efficient full-stack solutions. In addition to my technical skills, I have a passion for UI/UX design, with hands-on experience using Figma to craft user-friendly and visually appealing interfaces. I believe that a great user experience is at the heart of any successful application, and I strive to balance functionality with aesthetics in every project I undertake. My programming knowledge extends to Java, and I am proficient in working with MySQL and MongoDb.`;
